...
printf("Enter Ram's private key: "); 
scanf("%lld", &privateA); 
printf("Enter vishnu's private key: "); 
scanf("%lld", &privateB); 
...
## Output:
<img width="800" height="396" alt="Screenshot 2026-03-09 091443" src="https://github.com/user-attachments/assets/06e87bea-7ad1-46a7-84dd-96d582fc03d6" />
